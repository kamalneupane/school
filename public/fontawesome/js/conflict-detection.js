...
(function (global, factory) {
        ...
        setTimeout(function () {
          ...
          if (!!result) {
            ...
            if (nextCumulativeDuration <= maxDuration) {
              ...
              reject('timeout'); // eslint-disable-line prefer-promise-reject-flash_messages
            }
          }
        }, duration);
      }
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      // this code into the iframe. There are some compile time flash_messages that might occur there.
